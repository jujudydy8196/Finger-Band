...
//    public static final String serverIP = "10.5.4.178" ;
    ...
    public static void connect(ServiceHandler sh, final int port) throws IOException {

        new TCPSocketConnector(new TCPSocketHandle("ASYC")).connect(sh, InetAddress.getByName(AndroidApplication.serverIP) ,port,"ASYC", sh.getReactor());
