...
//	private Queue<Runnable> pendingTasks = new ConcurrentLinkedQueue<Runnable>();
	private HashMap<EventHandler,Integer> pendingHandler;
	...
	public Reactor() throws IOException{
		...
		pendingHandler=new HashMap<EventHandler,Integer>();
	...
	public void registerHandler(EventHandler eh,int eventType) throws ClosedChannelException {
		if(eh.getHandle() instanceof TCPSocketHandle){
            ...
            pendingHandler.put(eh, eventType);
			handle.getSocketChannel().register(selector, eventType,eh);
...
//                Iterator iterator = pendingHandler.entrySet().iterator();
//                while(iterator.hasNext()){
//                    Map.Entry pair = (Map.Entry)iterator.next();
//                    EventHandler eh = (EventHandler)pair.getKey();
//                    TCPSocketHandle handle=(TCPSocketHandle) eh.getHandle();
//                    Log.d(TAG,"I-(registerHandler)get handle");
//                    Integer eventType = (Integer)pair.getValue();
//                    handle.getSocketChannel().register(selector, eventType,eh);
//                }
//			    selector.wakeup();
//			    Log.d(TAG,"I-(registerHandler)register TCP to reactor finish");
